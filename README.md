...
| **Domain skills** | Keyword-matched skills inject domain-specific SQL patterns and analysis guidance for revenue, customers, inventory, cohorts, coding standards, performance optimization, data quality, and user behavior |
...
| Skills Router | — | Keyword scoring selects a domain skill (revenue, customers, inventory, cohorts, coding standards, performance, data quality, user behavior) or none |
